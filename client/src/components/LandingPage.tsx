...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      description:
        "Point your camera at objects around you and instantly see what they are in both English and your chosen language.",
      icon: "camera_alt",
      color: "#8F87F1",
    },
    {
      ...
      description:
        "Choose from several languages including Tamil, Hindi, Telugu, Malayalam and more.",
      icon: "translate",
      color: "#C68EFD",
    },
    {
      ...
      description:
        "No internet connection needed after initial setup. Perfect for learning anywhere.",
      icon: "wifi_off",
      color: "#E9A5F1",
    },
    {
      ...
      description:
        "Keep track of words you've learned and watch your vocabulary grow day by day.",
      icon: "bar_chart",
      color: "#FED2E2",
    },
    {
      ...
      description:
        "Earn points and see fun confetti animations when you learn new words.",
      icon: "celebration",
      color: "#8F87F1",
    },
    {
      ...
      description:
        "Enjoy an immersive learning experience with AR features on supported devices.",
      icon: "view_in_ar",
      color: "#C68EFD",
    },
    {
      ...
      description:
        "Create your own vocabulary lists to organize and review words by topics or categories.",
    ...
    },
    {
      ...
      description:
        "Detailed word cards with pronunciation guides and example contexts for better retention.",
      icon: "style",
      color: "#FED2E2",
    },
    {
      ...
      description:
        "Use the app on mobile, tablet, or desktop devices with seamless experience across all.",
      icon: "devices",
      color: "#8F87F1",
    },
    {
      ...
      description:
        "Share your learning progress and achievements with friends and family.",
      icon: "share",
      color: "#C68EFD",
    },
    {
      ...
      description:
        "Smart algorithm that adapts to your learning pace and focuses on words you need to practice.",
      icon: "tune",
      color: "#E9A5F1",
    },
    {
      ...
      description:
        "Fun mini-games that reinforce vocabulary learning through different challenges.",
      icon: "sports_esports",
      color: "#FED2E2",
    },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 overflow-y-auto overscroll-none">
      <NavBar />

      {/* Hero Section */}
      <div className="relative flex flex-col items-center justify-center px-4 pt-16 pb-8 md:pt-24 md:pb-12 w-full">
        ...
        <p className="text-xl text-gray-300 text-center max-w-2xl mb-8">
          Learn vocabulary in a natural way by pointing your camera at objects
          around you
        </p>
        ...
        <button
          ...
          style={{
            background:
              "linear-gradient(90deg, #8F87F1, #C68EFD, #E9A5F1, #FED2E2)",
          }}
        >
      ...
      <div className="relative container mx-auto px-4 py-16 mt-20">
        ...
        <h2
          className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#8F87F1] to-[#FED2E2] text-center mb-4"
          style={{ lineHeight: "3.5rem" }}
        >
          Amazing Features
        </h2>
        <p className="text-center text-gray-400 max-w-2xl mx-auto mb-12">
          Discover all the powerful tools and capabilities that vocabARy brings
          to make your language learning journey exciting and effective.
        </p>
        ...
        <div className="mt-16 mx-auto max-w-5xl bg-gradient-to-r from-gray-900/80 to-gray-800/80 p-8 rounded-2xl backdrop-blur-sm border border-white/10">
          <div className="flex flex-col md:flex-row items-start gap-8">
            <div className="w-full md:w-1/3 flex justify-center">
              <div className="w-32 h-32 flex items-center justify-center rounded-full bg-gradient-to-r from-[#8F87F1] to-[#E9A5F1]">
            ...
            <div className="w-full md:w-2/3">
              <h3 className="text-2xl font-bold text-white mb-3">
                A Smarter Way to Learn Languages
              </h3>
              <p className="text-gray-300 mb-4">
                Our unique approach combines visual learning with interactive
                technology to help you build your vocabulary faster and more
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <span className="material-icons text-[#C68EFD] mr-2 mt-0.5">
                      check_circle
                    </span>
      ...
      <div className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#C68EFD] to-[#E9A5F1] text-center mb-4">
            How It Works
          </h2>
          <p className="text-center text-gray-400 max-w-2xl mx-auto mb-16">
            Our simple three-step process makes learning new vocabulary
            ...
            {[
              {
                ...
                title: "Point Camera",
                description:
                  "Aim your device at objects around you that you want to learn.",
                icon: "camera_alt",
                color: "#8F87F1",
              ...
              },
              {
                ...
                description:
                  "The app automatically identifies objects and shows translations in your chosen language.",
                icon: "translate",
                color: "#C68EFD",
              ...
              },
              {
                ...
                title: "Learn & Earn",
                description:
                  "Mark words as learned, earn points, and watch your vocabulary grow with fun animations.",
                icon: "school",
                color: "#E9A5F1",
              ...
              >
                <div className="relative mb-8">
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${step.gradient} flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
          ...
          <div className="mt-16 text-center">
            <p className="text-gray-400 max-w-3xl mx-auto mb-8">
              The vocabARy approach is based on scientific research showing that
              associating words with visual cues dramatically improves retention
              and recall.
            </p>
            <button
              onClick={startLearning}
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-gray-900/60 to-gray-800/60 backdrop-blur-md rounded-3xl p-10 border border-white/10 shadow-xl">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Start learning new words in a fun and interactive way today. It's
              free, it's engaging, and it works!
            </p>
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-3">
              {[
                ...
                <span
                  key={i}
                  className="px-4 py-2 rounded-full bg-white/10 text-sm text-gray-300 border border-white/5"
                >
                  {tag}
                </span>
              ))}
